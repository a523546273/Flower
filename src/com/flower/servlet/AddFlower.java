...
public class AddFlower extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -3941549303725414336L;
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			...
			if (mapList.size()>0) {
				for (String key :mapList.keySet()) {
					if (key.equals("flowername")) {
						...
						flower.setPrice(Integer.valueOf(mapList.get(key)));
		...
		if (res==1) {
			...
			out.write("<script type='text/javascript'>alert('1111');location.href='#';</script>");
			out.flush();
			out.close();
		}
